...
%------------------------------------------------------------------------------
\subsection{\BibTool\ for Bib\LaTeX}

\BibTool contais the definitions to cope with \BibTeX\ files prepared for
Bib\LaTeX. These definitions are contained in the library \file{biblatex.rsc}.
It can be easily included on the command line:

\sh[r]{biblatex \texttt{-i} in.bib \texttt{-o} out.bib}
...
Certain fields deleted. The resource \rsc{delete.field} is provided to perform
this operation.
