...
Bind(	 "=",			     g_setq,		SYM_NONE, L_SET	     )
Bind(	 "==",			     g_eq,		SYM_NONE, L_EQ	     )
Bind(	 "!=",			     g_ne,		SYM_NONE, L_NE	     )
Bind(	 "<=",			     g_le,		SYM_NONE, L_LE	     )
Bind(	 "<",			     g_lt,		SYM_NONE, L_LT	     )
Bind(	 ">=",			     g_ge,		SYM_NONE, L_GE	     )
Bind(	 ">",			     g_gt,		SYM_NONE, L_GT	     )
Bind(	 "+",			     g_plus,		SYM_NONE, L_PLUS     )
Bind(	 "-",			     g_minus,		SYM_NONE, L_MINUS    )
Bind(	 "*",			     g_times,		SYM_NONE, L_TIMES    )
Bind(	 "/",			     g_div,		SYM_NONE, L_DIV	     )
Bind(	 "%",			     g_mod,		SYM_NONE, L_MOD	     )
Bind(	 "'",			     NULL,		SYM_NONE, L_QUOTE    )
Bind(	 "&&",			     g_and,		SYM_NONE, L_AND	     )
Bind(	 "||",			     g_or,		SYM_NONE, L_OR	     )
Bind(	 "!",			     g_not,		SYM_NONE, L_NOT	     )
Bind(	 "`",			     NULL,		SYM_NONE, L_FIELD    )
...
Bind(    "clear.ignored.words",	     g_cl_ign_words,	SYM_BUILTIN, L_FIELD )
...
Bind(	 "else",		     NULL,		SYM_NONE, L_ELSE     )
...
Bind(	 "function",		     NULL,		SYM_NONE, L_FUNCTION )
Bind(	 "input",		     g_input,		SYM_BUILTIN, L_FIELD )
Bind(	 "if",			     NULL,		SYM_NONE, L_IF	     )
BindFct( "ignored.word",	     g_ign_word,	add_ignored_word(val))
Bind(	 "ilike",		     NULL,		SYM_NONE, L_ILIKE    )
...
Bind(	 "like",		     NULL,		SYM_NONE, L_LIKE     )
Bind(	 "macro.file",		     g_macro_file,	SYM_BUILTIN, L_FIELD )
Bind(	 "mod",			     g_mod,		SYM_NONE, L_MOD	     )
...
Bind(	 "not",			     g_not,		SYM_NONE, L_NOT	     )
Bind(	 "nil",			     g_self,		SYM_NONE, L_CONS     )
Bind(	 "output.file",		     g_out_file,	SYM_BUILTIN, L_FIELD )
Bind(	 "or",			     g_or,	        SYM_NONE, L_OR	     )
...
Bind(	 "print",		     g_print,		SYM_BUILTIN, L_FIELD )
...
Bind(	 "quote",		     NULL,		SYM_NONE, L_QUOTE    )
...
Bind(	 "resource",		     NULL,		SYM_BUILTIN, L_FIELD )
...
Bind(	 "version",		     g_version,		SYM_BUILTIN, L_FIELD )
Bind(	 "while",		     NULL,		SYM_NONE, L_WHILE    )
Bind(	 "with",		     NULL,		SYM_NONE, L_WITH     )
