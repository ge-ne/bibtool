...
\begin{Releases}
 ...
 % =====================================================================
 \begin{Release}{2.68}{October 8, 2019}
  \begin{Fix}{gene}
    Initialization bug in key.c fixed which came up when using a title format
    without setting a fmt parameter.
  \end{Fix}
  \begin{Fix}{gene}
  ...
  \end{Update}
  \begin{Update}{gene}
    The format of the messages of \texttt{check\_rule} include file and line
    number.
  \end{Update}
  \begin{New}{gene}
  ...
  \end{Update}
  \begin{New}{gene}
    New source files |check.c| and |check.h| intruduced.
  \end{New}
 \end{Release}
