%%*****************************************************************************
%% $Id: Changes.tex,v 1.1 2010-05-31 16:15:40 gene Exp $
%%*****************************************************************************
...
\newenvironment{Fix}{\item }{}
\newenvironment{New}{\item }{}
\newenvironment{Doc}{\item }{}
\newenvironment{Update}{\item }{}
\newcommand\BS{\char`\\}
...
\end{Developers}
 ...
 \begin{Release}{2.50}{May 12, 2010}
  \begin{Fix}{gene}
    Bugfix in \File{names.c}: The classification of name parts erroursely has
 ...
 \begin{Release}{2.50}{February 6, 2010}
  \begin{Fix}{gene}
    Bugfix in \File{key.c}: The classification of name parts erroursely has
 ...
 %\begin{Release}{2.48}{February 8, 2004}
  ...
  \end{New}
  \begin{Update}{gene}
    Feature: When <code>expand.macros</code< is set the macros will be
  ...
  \begin{New}{gene}
    ...
    This resource can be used to force crossreferenced entries for
    selected entrie to be included in the output.
  \end{New}
  \begin{Update}{gene}
  ...
  \end{Update}
  \begin{Fix}{gene}
    Bugfix: Bug in extracting by aux file. Crossrefed entires where
    sometimes ignored.
  \end{Fix}
  \begin{Fix}{gene}
 ...
 \begin{Release}{2.42}{}
  ...
  \begin{New}{gene}
    ...
    controlls the entry types and the order in which they are printed.
