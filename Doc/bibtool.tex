%%*****************************************************************************
%% $Id: bibtool.tex,v 1.30 2011-12-14 18:46:46 gene Exp $
%%=============================================================================
%%
...
\newcommand\vrsc[1]{\textsf{\textit{#1}}}
...
\vrsc{name} is the resource name which conforms the rules of \BibTeX{}
reference keys. Thus \vrsc{name} can be composed of all characters but
...
resource \rsc{select.crossrefs}. This resource is |off| by default. This means
that cross-references are ignored.
...
word. For example: \RSc{ignored.word}{\(\{\)word\(\}\)}
...
delimiters. If a match is found then the matching sistering is replaced by the
...
even as comments. Then the default behavior can be changed with the Boolean
