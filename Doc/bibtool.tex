%%*****************************************************************************
%% $Id: bibtool.tex,v 1.24 2011-11-26 12:36:58 gene Exp $
%%=============================================================================
%%
...
command line arguments in single quotes (\verb|'|) if they contain whitespace
...
\verb|N|---which indicates the way of formating and the name of the field to
...
%------------------------------------------------------------------------------
\section{\BibTeX1 Support}

\BibTool\ supports already some of the feature proposed for \BibTeX1.
...
Nevertheless the resource  \rsc{apply.include} can be used to controll this
behaviour. 
...
Nevertheless the resource \rsc{apply.modify} can be used to controll this
behaviour.
