%%*****************************************************************************
%% $Id: bibtool.tex,v 1.4 2007-02-08 05:43:31 gene Exp $
%%=============================================================================
%%
...
\item[The bar] (\texttt{|}) separates two regular expressions. The combined
...
document.  Only those entries mentioned in the \texttt{aux} file are selected for
printing. Since the \BibTeX{} files are already named in the \texttt{aux} file it
...
This operation selects all entries containing \texttt{some string} in one of the
...
\begin{itemize}
  ...
  \item [\texttt{d}] Format a number, e.g.\ a year.\\
        ...
        \texttt{"june 1958"} formatted with \texttt{\%2d} results in
        \texttt{58}. 
        ...
        fails. Thus the specifier \texttt{\%0d} can be used to check for
        a number.
