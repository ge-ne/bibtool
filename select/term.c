...
** Returns:	nothing
**___________________________________________________			     */
static void dump_list(stream, t, in)		   /*                        */
  FILE * stream;				   /*                        */
  Term t;					   /*                        */
  int in;					   /*                        */
{						   /*                        */
  for (; t && TermOp(t) == CONS; t = TermTerm2(t)) /*                        */
...
{ int i;					   /*                        */
  ...
  { case -1:					   /*                        */
    ...
    case NUMBER:				   /*                        */
      ...
      return;					   /*                        */
    case BOOLEAN:				   /*                        */
      fprintf(stream, (TermNumber(t) !=0 ? "true" : "false"));/*             */
      return;					   /*                        */
    case NOT:					   /*                        */
      fputc('(', stream);			   /*                        */
